    ...
    try:
        ...
        for z in zones:
            ...
            try:
                ...
                # Compute distance in degrees and convert to nautical miles (1 deg ≈ 60 nm)
        ...
        # If no zone within 25nm, calculate base geographic distance to Palk Strait IMBL
        if not result:
            # Baseline IMBL calculation for Palk Bay / Gulf of Mannar sector
